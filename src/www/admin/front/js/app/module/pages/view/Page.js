define(function (require) {
    ...
    return Base.extend({
        ...
        renderMeta: function()
        {
            this.extend_view = new this.extradata( { model:this.model.get('page_meta') } );
            this.translation_view = new this.pagedata( { model:this.model.getTranslation() } );

            this.addView( {'.meta': new this.metadata( { model:this.model } ) } );
        ...
        renderTranslation: function()
        {
            ...
            if( !_.isUndefined( this.translation  ) )
            {
                if(_.isUndefined(this.translation_view)) {
                    ...
                    this.translation_view = new this.pagedata( { model:this.translation } );
        ...
        renderPageExtend: function()
        {
            ...
            if( !_.isUndefined( this.extend ) )
            {
                ...
                {
                    this.extend_view = new this.extradata( { model:this.extend } );
