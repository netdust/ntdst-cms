define(function (require) {
    ...
    var UserModel       = require('app/core/model/User');
    ...
    var SessionModel = Backbone.Model.extend({
        ...
        postAuth: function(opts, callback, args){
            ...
            $.ajax({
                ...
                error: function(mod, res){
                    if(callback && 'error' in callback) callback.error(mod.responseJSON);
                }
            }).complete( function(){
        ...
        recover: function(opts, callback, args){
            this.postAuth(_.extend(opts, { method: 'recover' }), callback);
        },
